// From http://www.ogre3d.org/tikiwiki/tiki-index.php?page=Debug+Drawing+Utility+Class
...
public:
    ...
    void drawArrow(const Ogre::Vector3 &start, const Ogre::Vector3 &end, const Ogre::ColourValue &colour);
    void drawLine(const Ogre::Vector3 &start, const Ogre::Vector3 &end, const Ogre::ColourValue &colour);
    void drawCircleSector(const Ogre::Vector3& centre, float radius, float angle_rads, const Ogre::Vector3& direction, int segmentsCount, const Ogre::ColourValue& colour, bool drawBoundingRadiuses = true, bool isFilled = false, const Ogre::Vector3& normal = Ogre::Vector3::UNIT_Y);
...
private:
    ...
    void buildArrow(const Ogre::Vector3& start, const Ogre::Vector3& end, const Ogre::ColourValue& colour, float alpha = 1.0f);
    ...
    int createCircleSectorVertices(const Ogre::Vector3& centre, float radius, float angle_rads, const Ogre::Vector3& direction, int segmentsCount, const Ogre::ColourValue& colour, bool drawBoundingRadiuses, const Ogre::Vector3& normal, float alpha = 1.0f, bool filled = false);

    void buildCircleSector(const Ogre::Vector3& centre, float radius, float angle_rads, const Ogre::Vector3& direction, int segmentsCount, const Ogre::ColourValue& colour, bool drawBoundingRadiuses, const Ogre::Vector3& normal, float alpha = 1.0f);
    void buildFilledCircleSector(const Ogre::Vector3& centre, float radius, float angle_rads, const Ogre::Vector3& direction, int segmentsCount, const Ogre::ColourValue& colour, const Ogre::Vector3& normal, float alpha = 1.0f);
    ...
    Ogre::ColourValue getColour(const Ogre::ColourValue& original, const float alpha) const;
};
